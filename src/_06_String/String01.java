...
public class String01 {
    ...
    public static void main(String[] args) {
        ...
        String str = "My name is SeongYeop Kim";
        ...
        System.out.println(str.indexOf("name")); //해당 위치 정보(0부터 셈)
        System.out.println(str.indexOf("age")); //만약 없으면 -1 출력

        System.out.println();

        str = "I like music and movie and travel";
        System.out.println(str.lastIndexOf("and")); //여러개 중에서 마지막
        System.out.println(str.lastIndexOf("java")); //없으면 -1 출력
